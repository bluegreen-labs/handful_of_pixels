...
The most simple approach around, used with or without explicit curve fitting, is the use of a simple threshold based method. Here, a phenology event is registered if a given VI threshold is exceeded. Although scaling these products for global coverage creating your own algorithm and implementing it on a local or regional scale is fairly simple.
