...
The `sf` package is relatively complex and for a full understanding of its components, consult the [package documentation](https://r-spatial.github.io/sf/) and the book by @lovelace_geocomputation_2019.
